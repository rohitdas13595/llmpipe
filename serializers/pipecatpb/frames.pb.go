// Pipecat-compatible wire format (pipecat/src/pipecat/frames/frames.proto).
// Generate: protoc --go_out=. --go_opt=paths=source_relative frames.proto
...
var file_frames_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x07, 0x0a, 0x05, 0x66, 0x72, 0x61, 0x6d, 0x65, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x6f, 0x68, 0x69, 0x74, 0x64, 0x61,
	0x73, 0x31, 0x33, 0x35, 0x39, 0x35, 0x2f, 0x6c, 0x6c, 0x6d, 0x70, 0x69, 0x70, 0x65, 0x2f, 0x73,
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x72, 0x73, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x63,
	0x61, 0x74, 0x70, 0x62, 0x3b, 0x70, 0x69, 0x70, 0x65, 0x63, 0x61, 0x74, 0x70, 0x62, 0x62, 0x06,
...
func file_frames_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_frames_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_frames_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_frames_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_frames_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_frames_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Frame); i {
			case 0:
				return &v.state
			case 1:
